...
('Sunset Paradise Hotel', 'Colombo', '123 Galle Road, Colombo 03', '+94 77 123 4567', 'info@sunsetparadise.com', 'A luxurious beachfront hotel with stunning ocean views and world-class amenities. Perfect for romantic getaways and business trips.', 5, 15000.00, 1),
('Mountain View Resort', 'Kandy', '456 Peradeniya Road, Kandy', '+94 81 234 5678', 'reservations@mountainview.com', 'Nestled in the hills of Kandy, offering panoramic views and serene surroundings. Ideal for nature lovers and cultural enthusiasts.', 4, 8500.00, 2),
('City Center Hotel', 'Colombo', '789 Union Place, Colombo 02', '+94 11 345 6789', 'bookings@citycenter.com', 'Modern hotel in the heart of Colombo with easy access to business districts and shopping centers.', 4, 12000.00, 1),
('Beachfront Villa', 'Galle', '321 Unawatuna Road, Galle', '+94 91 456 7890', 'info@beachfrontvilla.com', 'Exclusive beachfront property with private beach access and luxury amenities. Perfect for honeymoons and special occasions.', 5, 18000.00, 3),
('Heritage Inn', 'Anuradhapura', '654 Sacred City Road, Anuradhapura', '+94 25 567 8901', 'stay@heritageinn.com', 'Historic hotel near ancient temples, offering cultural experiences and spiritual retreats.', 3, 4500.00, 4),
('Tropical Resort', 'Negombo', '987 Beach Road, Negombo', '+94 31 678 9012', 'resort@tropical.com', 'Family-friendly resort with water sports and entertainment facilities. Great for family vacations.', 4, 7500.00, 2),
('Business Hotel', 'Colombo', '147 Independence Avenue, Colombo 07', '+94 11 789 0123', 'business@hotel.com', 'Executive hotel designed for business travelers with meeting facilities and conference rooms.', 4, 11000.00, 1),
('Garden Hotel', 'Nuwara Eliya', '258 Gregory Lake Road, Nuwara Eliya', '+94 52 890 1234', 'garden@hotel.com', 'Charming hotel surrounded by tea plantations and cool mountain air. Perfect for tea country tours.', 3, 6500.00, 3),
('Luxury Suites', 'Colombo', '369 Marine Drive, Colombo 03', '+94 11 901 2345', 'luxury@suites.com', 'Premium accommodation with personalized service and exclusive amenities. The ultimate in luxury.', 5, 22000.00, 4),
('Budget Inn', 'Colombo', '741 Pettah Market, Colombo 11', '+94 11 012 3456', 'budget@inn.com', 'Affordable accommodation in the bustling market area. Great value for money.', 2, 2500.00, 1),
('Seaside Hotel', 'Trincomalee', '852 Nilaveli Beach, Trincomalee', '+94 26 123 4567', 'seaside@hotel.com', 'Beachfront hotel with diving and water sports activities. Perfect for adventure seekers.', 4, 9000.00, 2),
('Grand Palace Hotel', 'Colombo', '159 Galle Face Green, Colombo 03', '+94 11 234 5678', 'info@grandpalace.com', 'Historic colonial hotel with modern amenities and ocean views. A landmark in Colombo.', 5, 19000.00, 5);
...
-- Insert Rooms (Prices in LKR) - More variety with images
...
(1, 'Family Suite', 18000.00, 'https://images.unsplash.com/photo-1564501049412-61c2a3083791?w=800&h=600&fit=crop'),
...
(2, 'Garden View Room', 7500.00, 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop'),
-- City Center Hotel
...
(3, 'Business Suite', 15000.00, 'https://images.unsplash.com/photo-1582719508461-905c673771fd?w=800&h=600&fit=crop'),
-- Beachfront Villa
...
(4, 'Ocean Suite', 17000.00, 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800&h=600&fit=crop'),
-- Heritage Inn
(5, 'Heritage Room', 4500.00, 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=800&h=600&fit=crop'),
(5, 'Standard Room', 3500.00, 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&h=600&fit=crop'),
-- Tropical Resort
...
(6, 'Beach View Room', 8000.00, 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800&h=600&fit=crop'),
-- Business Hotel
...
(7, 'Standard Room', 7500.00, 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&h=600&fit=crop'),
-- Garden Hotel
(8, 'Garden View Room', 6500.00, 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop'),
(8, 'Standard Room', 5000.00, 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&h=600&fit=crop'),
-- Luxury Suites
(9, 'Luxury Suite', 22000.00, 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&h=600&fit=crop'),
(9, 'Presidential Suite', 28000.00, 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&h=600&fit=crop'),
-- Budget Inn
(10, 'Budget Room', 2500.00, 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&h=600&fit=crop'),
(10, 'Standard Room', 2000.00, 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&h=600&fit=crop'),
-- Seaside Hotel
(11, 'Beach View Room', 9000.00, 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800&h=600&fit=crop'),
(11, 'Standard Room', 7500.00, 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&h=600&fit=crop'),
-- Grand Palace Hotel
(12, 'Heritage Suite', 19000.00, 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=800&h=600&fit=crop'),
(12, 'Ocean View Room', 17000.00, 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800&h=600&fit=crop'),
(12, 'Standard Room', 14000.00, 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&h=600&fit=crop');

-- Insert Hotel Packages (Prices in LKR) - More comprehensive packages with images
INSERT INTO hotel_package (hotel_id, package_name, description, price, image_url) VALUES
(1, 'Romantic Getaway', '2 nights with dinner and spa treatment for couples', 36000.00, 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=600&fit=crop'),
...
(1, 'Business Package', '1 week with meeting facilities and airport transfers', 100000.00, 'https://images.unsplash.com/photo-1582719508461-905c673771fd?w=800&h=600&fit=crop'),
...
(2, 'Cultural Experience', '3 nights with temple visits and cultural shows', 36000.00, 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=800&h=600&fit=crop'),
...
(4, 'Honeymoon Special', '5 nights with romantic dinners and spa treatments', 110000.00, 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=600&fit=crop'),
...
(6, 'Water Sports Package', '3 nights with diving and water activities', 36000.00, 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800&h=600&fit=crop'),
(8, 'Tea Country Tour', '2 nights with tea plantation visits', 20000.00, 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop'),
(9, 'Luxury Experience', '3 nights with butler service and premium amenities', 90000.00, 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=600&fit=crop'),
(12, 'Heritage Tour', '2 nights with historical site visits', 40000.00, 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=800&h=600&fit=crop');
...
(3, 2, 5, DATE_ADD(CURDATE(), INTERVAL 10 DAY), DATE_ADD(CURDATE(), INTERVAL 12 DAY), 2, 1, 'Vegetarian meals preferred, mountain view room', 17000.00, 'CONFIRMED'),
(2, 4, 11, DATE_ADD(CURDATE(), INTERVAL 15 DAY), DATE_ADD(CURDATE(), INTERVAL 18 DAY), 4, 2, 'Family vacation with children, beachfront villa', 108000.00, 'PENDING'),
(3, 6, 16, DATE_ADD(CURDATE(), INTERVAL 20 DAY), DATE_ADD(CURDATE(), INTERVAL 22 DAY), 3, 1, 'Family with young children, pool access needed', 15000.00, 'CONFIRMED'),
(2, 9, 25, DATE_ADD(CURDATE(), INTERVAL 25 DAY), DATE_ADD(CURDATE(), INTERVAL 28 DAY), 2, 1, 'Business trip, high-speed internet required', 66000.00, 'CONFIRMED'),
(3, 12, 30, DATE_ADD(CURDATE(), INTERVAL 30 DAY), DATE_ADD(CURDATE(), INTERVAL 32 DAY), 2, 1, 'Heritage tour package, guided tours requested', 28000.00, 'PENDING');
